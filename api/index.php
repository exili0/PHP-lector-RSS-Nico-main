...
<body>
    ...
    <table style='border: 5px #ca75d9ff solid; width:100%;'>
        <tr><th>TITULO</th><th>DESCRIPCIÓN</th><th>CATEGORÍA</th><th>ENLACE</th><th>FECHA</th></tr>
        ...
        <?php else: ?>
            <?php foreach($resultados as $row): ?>
                <tr>
                    ...
                    <td><?= $row['fPubli'] ? date('d-M-Y', strtotime($row['fPubli'])) : 'Sin fecha' ?></td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
    </table>
